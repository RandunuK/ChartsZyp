...
class CircularRadarArcChartViewController: DemoBaseViewController {

    @IBOutlet var chartView: CircularRadarArcChartView!
    ...
    override func viewDidLoad() {
        ...
        self.title = "Circular Radar Arc Chart"
...
extension CircularRadarArcChartViewController: IAxisValueFormatter {
