...
def project_name
  'ChartsZypDemo-iOS/ChartsZypDemo-iOS.xcodeproj'
end

def macos_project_name
  'ChartsZypDemo-macOS/ChartsZypDemo-macOS.xcodeproj'
end
...
task :update_pod do
  sh 'bundle exec pod trunk push ChartsZyp.podspec --allow-warnings'
end
