...
class CombinedChartTests: FBSnapshotTestCase
{
    ...
    {
        ChartsZypSnapshotVerifyView(chart, identifier: Snapshot.identifier(UIScreen.main.bounds.size), overallTolerance: Snapshot.tolerance)
    }
